...
<head>
	...
	<!-- start: CSS -->
	<link id="bootstrap-style" href="{{ asset('admin_pannel/css/bootstrap.min.css') }}" rel="stylesheet">
	<link href="{{ asset('admin_pannel/css/bootstrap-responsive.min.css') }}" rel="stylesheet">
	<link id="base-style" href="{{ asset('admin_pannel/css/style.css') }}" rel="stylesheet">
	<link id="base-style-responsive" href="{{ asset('admin_pannel/css/style-responsive.css') }}" rel="stylesheet">
	...
	<!--[if lt IE 9]>
		...
		<link id="ie-style" href="{{ asset('admin_pannel/css/ie.css') }}" rel="stylesheet">
	<![endif]-->

	<!--[if IE 9]>
		<link id="ie9style" href="{{ asset('admin_pannel/css/ie9.css') }}" rel="stylesheet">
	<![endif]-->
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{ url('/dashbord') }}"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li>
...
@yield('admin_content')
	...
	<!-- start: JavaScript-->
		...
		<script src="{{ asset('admin_pannel/js/jquery-1.9.1.min.js') }}"></script>
	<script src="{{ asset('admin_pannel/js/jquery-migrate-1.0.0.min.js') }}"></script>

		<script src="{{ asset('admin_pannel/js/jquery-ui-1.10.0.custom.min.js') }}"></script>

		<script src="{{ asset('admin_pannel/js/jquery.ui.touch-punch.js') }}"></script>

		<script src="{{ asset('admin_pannel/js/modernizr.js') }}"></script>

		<script src="{{ asset('admin_pannel/js/bootstrap.min.js') }}"></script>

		<script src="{{ asset('admin_pannel/js/jquery.cookie.js') }}"></script>





        <script src="{{ asset('admin_pannel/js/fullcalendar.min.js') }}"></script>

        <script src="{{ asset('admin_pannel/js/jquery.dataTables.min.js') }}"></script>




	<script src="{{ asset('admin_pannel/js/excanvas.js') }}"></script>
	<script src="{{ asset('admin_pannel/js/jquery.flot.js') }}"></script>
	<script src="{{ asset('admin_pannel/js/jquery.flot.pie.js') }}"></script>
	<script src="{{ asset('admin_pannel/js/jquery.flot.stack.js') }}"></script>
	<script src="{{ asset('admin_pannel/js/jquery.flot.resize.min.js') }}"></script>

		<script src="{{ asset('admin_pannel/js/jquery.chosen.min.js') }}"></script>

		<script src="{{ asset('admin_pannel/js/jquery.uniform.min.js') }}"></script>

		<script src="{{ asset('admin_pannel/js/jquery.cleditor.min.js') }}"></script>

		<script src="{{ asset('admin_pannel/js/jquery.noty.js') }}"></script>

		<script src="{{ asset('admin_pannel/js/jquery.elfinder.min.js') }}"></script>

		<script src="{{ asset('admin_pannel/js/jquery.raty.min.js') }}"></script>

		<script src="{{ asset('admin_pannel/js/jquery.iphone.toggle.js') }}"></script>

		<script src="{{ asset('admin_pannel/js/jquery.uploadify-3.1.min.js') }}"></script>

		<script src="{{ asset('admin_pannel/js/jquery.gritter.min.js') }}"></script>

		<script src="{{ asset('admin_pannel/js/jquery.imagesloaded.js') }}"></script>

		<script src="{{ asset('admin_pannel/js/jquery.masonry.min.js') }}"></script>

		<script src="{{ asset('admin_pannel/js/jquery.knob.modified.js') }}"></script>

		<script src="{{ asset('admin_pannel/js/jquery.sparkline.min.js') }}"></script>

		<script src="{{ asset('admin_pannel/js/counter.js') }}"></script>

		<script src="{{ asset('admin_pannel/js/retina.js') }}"></script>

		<script src="{{ asset('admin_pannel/js/custom.js') }}"></script>
	<!-- end: JavaScript-->
