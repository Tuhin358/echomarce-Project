              ...
              <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <img src="{{ asset('/image/'.$images) }}" style="width:80px; height:50px;">
                    ...
                    <td class="row">
                        ...
                        <div class="span2 ">
                            @if($product->status==1)
                        <a  href="{{ url('/products-status'.$product->id) }}" class="btn btn-success">
                            <i class="halflings-icon white thumbs-down"></i>
                        </a>
                        @else
                        <a  href="{{ url('/products-status'.$product->id) }}" class="btn btn-danger">
