            ...
            <div class="col-md-3 col-xs-6">
                <div class="product">
                    ...
                    <div class="product-body">
                        <p class="product-category"> <a href="{{ url('/view_details'.$related_product->id) }} " > {{ $related_product->category->name }}</a></p>
                        <h3 class="product-name"><a href="{{ url('/view_details'.$related_product->id) }}">{{ $related_product->name }}</a></h3>
                        <h4 class="product-price"><a href="{{ url('/view_details'.$related_product->id) }}"> &#2547;{{ $related_product->price }}<del class="product-old-price">&#2547;{{ $related_product->price }}</del></a></h4>
                        <div class="product-rating">
                        </div>
