    ...
    <div id="top-header">
        <div class="container">
            <ul class="header-links pull-left">
                <li><a href="#"><i class="fa fa-phone"></i>01521-310761</a></li>
                <li><a href="#"><i class="fa fa-envelope-o"></i>tarifulislam2400@gmail.com</a></li>
                <li><a href="#"><i class="fa fa-map-marker"></i>Dhaka,Mirpur-6</a></li>
            </ul>
            <ul class="header-links pull-right">
                <li><a href="#"><i class="fa-solid fa-bangladeshi-taka-sign"></i> &#2547;</a></li>


                {{--  <li><a href="{{ url('/login-check') }}"><i class="fa fa-user-o"></i> Account</a></li>  --}}
